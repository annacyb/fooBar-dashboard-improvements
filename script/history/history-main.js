...
function displayOrder(order) {
    ...
    clone.querySelector("[data-field=value]").textContent =
        order.value + " DKK";
    ...
    clone
        .querySelector("#row")
        .addEventListener("click", () => showPopUp(details, order.id));
...
function showPopUp(order, id) {
    ...
    popup.querySelector(".total").innerHTML =
        "Total: " + order.length * 40 + " DKK";
